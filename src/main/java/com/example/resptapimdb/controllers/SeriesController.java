...
import com.example.resptapimdb.models.Series;
import com.example.resptapimdb.services.SeriesService;
...
public class SeriesController 
{
    ...
    {
        var customizedResponse = new CustomizedResponse(" Series with ID:  " + id + "was updated successfully " , Collections.singletonList(service.editSeries(id, newSeries)));
